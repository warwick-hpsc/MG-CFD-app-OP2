...
void cgppcacguard2l_(unsigned long *gp_cu, unsigned long *gp_cue,
   ...
   std::complex<float> *g_cu;
   float *g_cue, *g_scs;
   g_cu = (std::complex<float> *)*gp_cu;
   g_cue = (float *)*gp_cue;
   g_scs = (float *)*gp_scs;
...
void cgppcaguard2l_(unsigned long *gp_q, unsigned long *gp_qe,
                    ...
                    int *nypmx, int *nxvh, int *kypd) {
   std::complex<float> *g_q;
   float *g_qe, *g_scs;
   g_q = (std::complex<float> *)*gp_q;
   g_qe = (float *)*gp_qe;
   g_scs = (float *)*gp_scs;
...
void cgppcbguard2l_(unsigned long *gp_fxyz, unsigned long *gp_fxyze,
                    ...
                    int *nx, int *nyp, int *kstrt, int *nvp, int *ndim,
                    int *nxe, int *nypmx, int *nxvh, int *kypd) {
   std::complex<float> *g_fxyz;
   float *g_fxyze, *g_scs;
   g_fxyz = (std::complex<float> *)*gp_fxyz;
...
void cwappfft2rcs_(unsigned long *gp_f, unsigned long *gp_g,
   ...
   std::complex<float> *g_f, *g_g, *g_bsm, *g_brm, *g_sct;
   int *g_mixup;
   g_f = (std::complex<float> *)*gp_f;
   g_g = (std::complex<float> *)*gp_g;
   g_bsm = (std::complex<float> *)*gp_bsm;
   g_brm = (std::complex<float> *)*gp_brm;
   g_mixup = (int *)*gp_mixup;
   g_sct = (std::complex<float> *)*gp_sct;
...
void cwappfft2rcsn_(unsigned long *gp_fn, unsigned long *gp_gn,
   ...
   std::complex<float> *g_fn, *g_gn, *g_bsm, *g_brm, *g_sct;
   int *g_mixup;
   g_fn = (std::complex<float> *)*gp_fn;
   g_gn = (std::complex<float> *)*gp_gn;
   g_bsm = (std::complex<float> *)*gp_bsm;
   g_brm = (std::complex<float> *)*gp_brm;
   g_mixup = (int *)*gp_mixup;
   g_sct = (std::complex<float> *)*gp_sct;
...
void gpuppfft2rrcu_(unsigned long *gp_f, unsigned long *gp_g,
                    ...
                    int *nvp, int *kxpd, int *kyp, int *nxhd, int *nyd,
                    int *kypd) {
   std::complex<float> *g_f, *g_g, *g_bsm, *g_brm;
   g_f = (std::complex<float> *)*gp_f;
   g_g = (std::complex<float> *)*gp_g;
   g_bsm = (std::complex<float> *)*gp_bsm;
   g_brm = (std::complex<float> *)*gp_brm;
...
void gpuppfft2rrcun_(unsigned long *gp_fn, unsigned long *gp_gn,
                     ...
                     int *nvp, int *ndim, int *kxpd, int *kyp, int *nxhd,
                     int *nyd, int *kypd) {
   std::complex<float> *g_fn, *g_gn, *g_bsm, *g_brm;
   g_fn = (std::complex<float> *)*gp_fn;
   g_gn = (std::complex<float> *)*gp_gn;
   g_bsm = (std::complex<float> *)*gp_bsm;
   g_brm = (std::complex<float> *)*gp_brm;
...
void cgpptpose_(unsigned long *gp_bsm, unsigned long *gp_btm,
                std::complex<float> *sm, std::complex<float> *tm, int *nx, int *ny,
                int *kxp, int *kyp, int *kstrt, int *nvp) {
   std::complex<float> *g_bsm, *g_btm;
   g_bsm = (std::complex<float> *)*gp_bsm;
   g_btm = (std::complex<float> *)*gp_btm;
