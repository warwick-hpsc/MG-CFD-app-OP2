...
/* g_bsm/g_brm = complex send/receive buffers for data transpose */
   std::complex<float> *g_bsm = NULL, *g_brm = NULL;
...
/* bsm/brm = complex send/receive buffers for data transpose */
   std::complex<float> *bsm = NULL, *brm = NULL;
...
/* allocate data for standard code */
   ...
   ffct = (std::complex<float> *) malloc(nyh*kxpd*sizeof(std::complex<float>));
   ...
   qt = (std::complex<float> *) malloc(ny*kxpd*sizeof(std::complex<float>));
   fxyzt = (std::complex<float> *) malloc(ny*ndim*kxpd*sizeof(std::complex<float>));
