...
void compute_bnd_node_flux_kernel_vec( const int *g, const double *edge_weight, const double variables_b[*][SIMD_VEC], double fluxes_b[*][SIMD_VEC], int idx ) {
...
void op_par_loop_compute_bnd_node_flux_kernel(char const *name, op_set set,
  ...
  OP_kernels[10].times[0] += wall_t2 - wall_t1;
