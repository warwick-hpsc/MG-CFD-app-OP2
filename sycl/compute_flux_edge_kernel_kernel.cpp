            ...
            for ( int n=item.get_local_id(0); n<nelems2; n+=item.get_local_range()[0] ){
              ...
              for ( int col=0; col<ncolor; col++ ){
                if (col2==col) {
                  ...
                  arg4_l[0] += ind_arg1_s[0+arg4_map*5];
                  arg4_l[1] += ind_arg1_s[1+arg4_map*5];
                  arg4_l[2] += ind_arg1_s[2+arg4_map*5];
                  arg4_l[3] += ind_arg1_s[3+arg4_map*5];
                  arg4_l[4] += ind_arg1_s[4+arg4_map*5];
                  ind_arg1_s[0+arg4_map*5] = arg4_l[0];
                  ind_arg1_s[1+arg4_map*5] = arg4_l[1];
                  ind_arg1_s[2+arg4_map*5] = arg4_l[2];
                  ind_arg1_s[3+arg4_map*5] = arg4_l[3];
                  ind_arg1_s[4+arg4_map*5] = arg4_l[4];
                }
                item.barrier(cl::sycl::access::fence_space::local_space);
              }
            }
