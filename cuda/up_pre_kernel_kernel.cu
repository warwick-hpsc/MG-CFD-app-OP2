...
__constant__ int opDat0_up_pre_kernel_stride_OP2CONSTANT;
...
void op_par_loop_up_pre_kernel(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    if ((OP_kernels[16].count==1) || (opDat0_up_pre_kernel_stride_OP2HOST != getSetSizeFromOpArg(&arg0))) {
      ...
      cudaMemcpyToSymbol(opDat0_up_pre_kernel_stride_OP2CONSTANT, &opDat0_up_pre_kernel_stride_OP2HOST,sizeof(int));
    }
