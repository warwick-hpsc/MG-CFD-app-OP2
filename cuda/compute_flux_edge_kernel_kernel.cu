...
__constant__ int opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT;
int opDat0_compute_flux_edge_kernel_stride_OP2HOST=-1;
__constant__ int direct_compute_flux_edge_kernel_stride_OP2CONSTANT;
...
__global__ void op_cuda_compute_flux_edge_kernel(
  ...
  if (tid + start < end) {
    ...
    compute_flux_edge_kernel_gpu(ind_arg0+map0idx,
                             ...
                             arg3_l,
                             arg4_l);
    atomicAdd(&ind_arg1[0*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map0idx],arg3_l[0]);
    atomicAdd(&ind_arg1[1*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map0idx],arg3_l[1]);
    atomicAdd(&ind_arg1[2*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map0idx],arg3_l[2]);
    atomicAdd(&ind_arg1[3*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map0idx],arg3_l[3]);
    atomicAdd(&ind_arg1[4*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map0idx],arg3_l[4]);
    atomicAdd(&ind_arg1[0*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map1idx],arg4_l[0]);
    atomicAdd(&ind_arg1[1*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map1idx],arg4_l[1]);
    atomicAdd(&ind_arg1[2*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map1idx],arg4_l[2]);
    atomicAdd(&ind_arg1[3*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map1idx],arg4_l[3]);
    atomicAdd(&ind_arg1[4*opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT+map1idx],arg4_l[4]);
  }
}
...
void op_par_loop_compute_flux_edge_kernel(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    if ((OP_kernels[9].count==1) || (opDat0_compute_flux_edge_kernel_stride_OP2HOST != getSetSizeFromOpArg(&arg0))) {
      ...
      cudaMemcpyToSymbol(opDat0_compute_flux_edge_kernel_stride_OP2CONSTANT, &opDat0_compute_flux_edge_kernel_stride_OP2HOST,sizeof(int));
    }
    if ((OP_kernels[9].count==1) || (direct_compute_flux_edge_kernel_stride_OP2HOST != getSetSizeFromOpArg(&arg2))) {
      ...
      cudaMemcpyToSymbol(direct_compute_flux_edge_kernel_stride_OP2CONSTANT,&direct_compute_flux_edge_kernel_stride_OP2HOST,sizeof(int));
    }
