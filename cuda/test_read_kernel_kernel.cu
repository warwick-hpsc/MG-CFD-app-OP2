...
//user function
__device__ void test_read_kernel_gpu( 
...
__global__ void op_cuda_test_read_kernel(
  ...
  if (tid + start < end) {
    ...
    test_read_kernel_gpu(ind_arg0+map0idx*5,
                     ind_arg0+map1idx*5,
                     arg2+n*3,
                     arg3_l,
                     arg4_l);
  ...
  if (set_size > 0) {
    ...
    for ( int round=0; round<2; round++ ){
      ...
      if (end-start>0) {
        ...
        op_cuda_test_read_kernel<<<nblocks,nthread>>>(
        (double *)arg0.data_d,
        (double *)arg3.data_d,
        arg0.map_data_d,
        (double*)arg2.data_d,
