...
defaults["output intermediate flows interval"] = 0
# Partitioning:
...
if __name__=="__main__":
    ...
    output_intermediate_flows_interval = get_key_value(profile, "run", "output intermediate flows interval")
    ...
    for repeat in range(num_repeats):
        for item in iterables_labelled:
            ...
            py_sed(batch_tmp_filepath, "<OUTPUT_INTERMEDIATE_FLOWS_INTERVAL>", output_intermediate_flows_interval)
